...
language: '\RequirePackage[brazil,english]{babel}' # Revert to [english,brazil] for portuguese
title: 'My Final College Paper'
foreigntitle: 'Foreign Title'
# EDIT author and advisor names on template.tex file
department: 'PESC'
date_month: '09'
date_year: '2020'
# EDIT keywords on template.tex file
