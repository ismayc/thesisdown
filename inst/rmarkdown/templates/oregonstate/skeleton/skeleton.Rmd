...
# altadvisor: 'Your Other Advisor' # uncomment this line to add another advisor
...
# a different format than PDF, you can delete or ignore lines 20-31 in this YAML
# header.
abstract: >
  `r if(knitr:::is_latex_output()) thesisdown::inc("00-abstract.Rmd")`
# If you'd rather include the preliminary content in files instead of inline
# like below, use a command like that for the abstract above.  Note that a tab is 
# needed on the line after the >.
acknowledgements: >
  `r if(knitr:::is_latex_output()) thesisdown::inc("00-acknowledgements.Rmd")`
...
contributors: >	
  stuff and such here
  this will be renedred?
dedication: >
  This is for my mother.
preface: >	
  more suff here will be renedered?
#header-includes:
#- \usepackage{tikz}
---
