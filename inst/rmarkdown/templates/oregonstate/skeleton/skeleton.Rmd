...
date: 'January 1, 2013' # note: this is date of submission
...
many places copied directly from) the [0][Oregon State University LaTeX
template] and wrapped up into Chester Ismay's [1][*thesisdown* package], but
